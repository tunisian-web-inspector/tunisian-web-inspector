...
<div class="d-none d-lg-block">
   <svg class="rounded-circle img-fluid img-profile mx-auto" width="128" height="128" style="enable-background:new 0 0 128 128;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g>
                ...
                <path id="XMLID_8_" d="M51.59,90.23H42.5v9.59c0,4.34,3.7,7.86,8.26,7.86h1.65c4.56,0,8.26-3.52,8.26-7.86 v-9.59H51.59z" style="fill:#E49500;"/>
                ...
                <g>
                    <path id="XMLID_464_" d="M83.9,52.37c0,0,5.89,1.02,5.89,7.37c0,5.6-4.3,7.81-8.6,7.81V52.37H83.9z" style="fill:#E39400;"/>
                    <path id="XMLID_463_" d="M19.62,52.37c0,0-5.89,1.02-5.89,7.37c0,5.6,4.3,7.81,8.6,7.81V52.37H19.62z" style="fill:#E39400;"/>
                    <path id="XMLID_461_" d="M51.76,10.8c-25.4,0-32.04,19.69-32.04,47.35c0,28.68,18.43,36.1,32.04,36.1 c13.41,0,32.04-7.2,32.04-36.1C83.8,30.49,77.16,10.8,51.76,10.8z" style="fill:#FAC01B;"/>
                    <path id="XMLID_460_" d="M41.21,60.72c0,2.86-1.91,5.17-4.28,5.17c-2.36,0-4.29-2.32-4.29-5.17 c0-2.86,1.92-5.18,4.29-5.18C39.29,55.54,41.21,57.85,41.21,60.72" style="fill:#444444;"/>
                    ...
                    <path id="XMLID_458_" d="M61.03,78.19c-1.3,0-9.27,0-9.27,0s-7.98,0-9.27,0c-1.06,0-1.52,0.71-0.82,1.79 c0.98,1.5,4.64,4.38,10.09,4.38s9.11-2.88,10.09-4.38C62.55,78.9,62.09,78.19,61.03,78.19z" style="fill:#513F35;"/>
                    <path id="XMLID_457_" d="M56.24,70.31c-1.58,0.45-3.22,0.66-4.48,0.66s-2.9-0.22-4.48-0.66 c-0.67-0.19-0.94,0.45-0.7,0.87c0.5,0.88,2.52,2.66,5.18,2.66c2.66,0,4.68-1.78,5.18-2.66C57.18,70.75,56.91,70.11,56.24,70.31z" style="fill:#E39400;"/>
                ...
                <path id="XMLID_20_" d="M60.4,60.71c0,4,2.68,7.24,6,7.24c3.31,0,6-3.24,6-7.24c0-4.01-2.69-7.25-6-7.25 C63.08,53.46,60.4,56.7,60.4,60.71" style="fill:#444444;"/>
                <g>
...
HTML,
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Entités', 'url' => ['/legal-entity/index']],
            ['label' => 'A propos', 'url' => ['/default/about']],
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        ...
        <?= Breadcrumbs::widget([
            'homeLink' => ['encode' => false, 'label' => Html::fa('home'), 'url' => ['default/index']],
...
<footer class="footer mt-auto py-3 text-muted">
    <div class="container">
        <p class="float-start"><a href="https://twitter.com/mac_hour" target="_blank" rel="noopener">@mac_hour</a></p>
